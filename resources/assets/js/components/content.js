...
function content(props) {
    ...
    let TitleBarData = [
        { type: '申請年度', value: props.data['year'] },
        {
            type: '排名',
            value: props.data['rank_1'] + ' / ' + props.data['rank_2'],
        },
        { type: '學年分數', value: props.data['score'] },
        { type: '轉出科系', value: props.data['out_maj'] },
    ];
    ...
    return (
        <div className="content_container">
            <Modal
                ...
                style={contentStyle(props.mobile)}
                className="Modal"
            ...
            >
                ...
                <button
                    ...
                    id="rightBtn"
                    onClick={props.next.bind(this, 'next')}
                >
                ...
                <button
                    className="contentBtn"
                    id="leftBtn"
                    onClick={props.next.bind(this, 'before')}
                >
