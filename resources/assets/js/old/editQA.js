...
class editQA extends Component {
    ...
    changeFliter(new_fliter, type) {
        if (this.state.display === 'none') this.setState({ openFliter: false });
        var show = [];
        var tag = [];
        ...
        if (type === 'confirm') {
            if (new_fliter === '全部') var condition = '全部';
            else var condition = new_fliter === '已審核' ? 'true' : 'false';
            this.setState({ confirmFliter: condition });
        } else var condition = this.state.confirmFliter;
    ...
    handleRWD(mobile) {
        if (mobile) this.setState({ display: 'none', openFliter: false });
        else this.setState({ display: 'block', openFliter: true });
    }
        ...
        return (
            <div className="edit">
                ...
                >
                    <div
                        style={{
                            width: '90%',
                            margin: '5% 5%',
                            display: this.state.qa_id === -1 ? 'none' : 'block',
                        }}
                    >
                        <br />
                ...
                <div
                    className="index"
                    style={{
                        display: this.state.qa_id === -1 ? 'block' : 'none',
                        top: '100px',
                    }}
                >
                    {switchIndex()}
                ...
                >
                    ...
                    />
                    <Button
                        onClick={this.changeFliter.bind(this, 'tag', 'tag')}
                        style={{
                            outline: 'none',
                            width: '86%',
                            margin: '5px 7%',
                    ...
                    <Button
                        onClick={this.changeFliter.bind(this, 'tag', 'none')}
                        style={{
                            outline: 'none',
                            width: '86%',
                            margin: '5px 7%',
