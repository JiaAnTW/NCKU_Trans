...
class post extends Component {
    ...
    render() {
        const spawnYear = () => {
            ...
            for (var i = clock.getFullYear(); i > 2014; --i) {
                if (i != clock.getFullYear() || clock.getMonth() + 1 > 7)
                    output.push(<option value={i - 1911}>{i - 1911}</option>);
            }
            return (
                <select
                    id="year"
        ...
        const maj_option = this.state.is_fetch ? (
            this.state.NCKU.map((department) => {
                return (
                    <option value={department} style={{ textAlign: 'center' }}>
                        {department}
                    </option>
                );
            })
        ...
        const maj_option2 = this.state.is_fetch ? (
            this.state.secondNCKU.map((department) => {
                return (
                    <option value={department} style={{ textAlign: 'center' }}>
                        {department}
                    </option>
                    ...
                    <div className="type-box">
                        <div className="card-box">
                            <div className="header-box">
                                <img src={Man} alt="man" />
                                <h1 style={{ fontWeight: '500' }}>心得</h1>
                            </div>
                            <p>
                                主要是針對個別科系分享平均分數以及修課等內容
                                <button
                                    onClick={(e) =>
                                        this.setState({
                                            is_send: 2,
                        ...
                        <div className="card-box">
                            <div className="header-box">
                                ...
                                <h1 style={{ fontWeight: '500' }}>常見問答</h1>
                            </div>
                            <p>
                                主要是解答轉系在行政、審查等流程和規則上的模糊點
                                <button
                                    onClick={(e) =>
                                        this.setState({
                                            is_send: 2,
                    ...
                    >
                        <div style={{ padding: '7% 7%' }}>
                            ...
                            <p>
                                <br />
                                轉入科系:
                                <select id="in_maj" onChange={this.changeIn}>
                                    {maj_option}
                                </select>
                            </p>
                            <div className="send-box">
        ...
        const postStage = () => {
            if (this.state.is_send == 1) {
                ...
                this.state.is_send > 1 &&
                this.state.editObject === 'comment'
            ) {
                const notHereStyle = {
        ...
        return (
            <div className="post">
                <div className="index">{postStage()}</div>
            </div>
        );
    }
}
